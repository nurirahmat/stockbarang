...
public class DaftarBarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${kemasan}"));
        columnBinding.setColumnName("Kemasan");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${barangRusak}"));
